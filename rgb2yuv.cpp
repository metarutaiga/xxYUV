...
void rgb2yuv(int width, int height, const void* rgb, int strideRGB, void* y, void* u, void* v, int strideY, int strideU, int strideV)
{
    ...
    for (int h = 0; h < halfHeight; ++h)
    {
        ...
        {
            int b00 = (rgbWidth >= 1) ? rgb0[0] : 255;
            int g00 = (rgbWidth >= 2) ? rgb0[1] : 255;
            int r00 = (rgbWidth >= 3) ? rgb0[2] : 255;
            int a00 = (rgbWidth >= 4) ? rgb0[3] : 255; rgb0 += rgbWidth;
            int b01 = (rgbWidth >= 1) ? rgb0[0] : 255;
            int g01 = (rgbWidth >= 2) ? rgb0[1] : 255;
            int r01 = (rgbWidth >= 3) ? rgb0[2] : 255;
            int a01 = (rgbWidth >= 4) ? rgb0[3] : 255; rgb0 += rgbWidth;
            int b10 = (rgbWidth >= 1) ? rgb1[0] : 255;
            int g10 = (rgbWidth >= 2) ? rgb1[1] : 255;
            int r10 = (rgbWidth >= 3) ? rgb1[2] : 255;
            int a10 = (rgbWidth >= 4) ? rgb1[3] : 255; rgb1 += rgbWidth;
            int b11 = (rgbWidth >= 1) ? rgb1[0] : 255;
            int g11 = (rgbWidth >= 2) ? rgb1[1] : 255;
            int r11 = (rgbWidth >= 3) ? rgb1[2] : 255;
            int a11 = (rgbWidth >= 4) ? rgb1[3] : 255; rgb1 += rgbWidth;
